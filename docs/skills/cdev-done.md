...
**Does it always want a hardware result?** It wants what the `Verification:` line in AGENTS.md asks for. At `off` it closes on the build and the run, and records what was not checked on hardware.
