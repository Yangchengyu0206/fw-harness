...
**Why does it record terms?** An interview that runs on two meanings of one word settles nothing, and the words that trip up a new reader are the same ones that trip up an agent. Only the ones that actually caused confusion are written down.
